...
const PlacesPage = () => {
    ...
    const [masGuests, setMaxGuests] = useState(1);
            ...
            {action === 'new' && (
                <div>
                    <form>
                        ...
                        <input type="text" placeholder="title, for example: My love apt" />
                        ...
                        <div className="mt-2 grid grid-cols-3 md:grid-cols-4 lg:grid-cols-6">
                            <button className="flex justify-center border bg-trasnparent rounded-2xl p-8 text-2xl text-gray-600">
                        ...
                        <div className="grid mt-2 gap-2 grid-cols-2  md:grid-cols-4 lg:grid-cols-6">
                            ...
                            <label className="border p-4 flex rounded-2xl gap-2 items-cente cursor-pointer">
                                <input type="checkbox" />
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                        ...
                        <div className="grid gap-2 sm:grid-cols-3">
                            ...
                            <div>
                                ...
                                <input type="text" placeholder="Example 2 people" />
                            </div>
                        </div>
